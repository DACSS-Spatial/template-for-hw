...
gpklink='https://github.com/DACSS-Spatial/template-for-hw/raw/refs/heads/main/MapFromPython1.gpkg'
jsonlink='https://github.com/DACSS-Spatial/template-for-hw/raw/refs/heads/main/MapFromPython2.geojson'
```
...
```{r}
library(ggplot2)
map1gg=ggplot() + theme_bw() + geom_sf(data = map1,
                                       fill='red',
                                       color='grey90')
map1gg
